...
const STRINGS = {
  en: {
    ...
    resultsTitle: 'Result times',
    spanMusicTotal: 'Music total',
    spanMainSection: 'Main section',
  ...
  de: {
    ...
    resultsTitle: 'Ergebniszeiten',
    spanMusicTotal: 'Musik gesamt',
    spanMainSection: 'Hauptteil',
...
const SPAN_KEYS = {
  musicTotal: 'spanMusicTotal',
  mainSection: 'spanMainSection',
};

export function spanName(type) {
  return t(SPAN_KEYS[type]);
}
